...
<input class="btn btn-info" type="button" id="openPlay" onclick="startQuartz('理财收益')" value="开启理财收益"/>
<input class="btn btn-info" type="button" id="closePlay" onclick="removeQuartz('理财收益')" value="关闭理财收益"/>	<hr/>
<input class="btn btn-info" type="input" id="sysRedNum"   value="红包个数"onfocus="if(value=='红包个数'){value=''}"onblur="if(value==''){value='红包个数'}"style="margin-top:4px;margin-left:8px;"/>
<input class="btn btn-info" type="input" id="sysRedMoney"  value="金额"onfocus="if(value=='金额'){value=''}"onblur="if(value==''){value='金额'}"style="margin: 4px;margin-left:8px;"/>

<input class="btn btn-info" type="button" id="openSysRed" onclick="startQuartz('系统红包')" value="开启系统红包"/>
<input class="btn btn-info" type="button" id="closeSysRed" onclick="removeQuartz('系统红包')" value="关闭系统红包"/>	
<hr/>
