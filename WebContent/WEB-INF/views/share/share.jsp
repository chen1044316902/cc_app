...
<table style="border:0;table-layout:fixed;text-align:center">
  <tr>
  	<td style="width:7%;background-size:80%;background-repeat:no-repeat;background-position:left;background-image:url(${map.list[0].avatar});"></td>
    <td style="width:20%">
    	<c:if test="${fn:length(map.list[0].nickName)>5 } ">
			${fn:substring(map.list[0].nickName, 0,5)}...
		</c:if>
		<c:if test="${fn:length(map.list[0].nickName)<=5 }">
			${map.list[0].nickName}
		</c:if>
    ...
    <td style="width:15%">点赞: ${map.list[0].videoLikingCount}</td>
  	<td style="width:7%;background-size:80%;background-repeat:no-repeat;background-position:center;background-image:url(data:image/png;base64,);"></td>
    <td style="width:15%">评论: ${map.list[0].videoCommentCount}</td>
    <td style="width:1%"></td>
  	<td style="width:7%;background-size:80%;background-repeat:no-repeat;background-position:right;background-image:url(data:image/png;base64,);"></td>
    <td style="width:15%">转发: ${map.list[0].videoSendingCount}</td>
    <td style="width:1%"></td>
    </div>
  </tr>
</table>
...
<table style="border:0;table-layout:fixed;text-align:center">
  <tr>
  	<td style="width:7%;background-size:80%;background-repeat:no-repeat;background-position:left;background-image:url(${map.list[1].avatar});"></td>
    <td style="width:20%">
    	<c:if test="${fn:length(map.list[1].nickName)>5 } ">
			${fn:substring(map.list[1].nickName, 0,5)}...
		</c:if>
		<c:if test="${fn:length(map.list[1].nickName)<=5 }">
			${map.list[1].nickName}
		</c:if>
  	...
  	<td style="width:5%;background-size:80%;background-repeat:no-repeat;background-position:left;background-image:url(data:image/png;base64,);"></td>
    <td style="width:15%">点赞: ${map.list[1].videoLikingCount}</td>
  	<td style="width:7%;background-size:80%;background-repeat:no-repeat;background-position:center;background-image:url(data:image/png;base64,);"></td>
    <td style="width:15%">评论: ${map.list[1].videoCommentCount}</td>
    <td style="width:1%"></td>
  	<td style="width:7%;background-size:80%;background-repeat:no-repeat;background-position:right;background-image:url(data:image/png;base64,);"></td>
    <td style="width:15%">转发: ${map.list[1].videoSendingCount}</td>
    <td style="width:1%"></td>
    </div>
  </tr>
</table>
...
<table style="border:0;table-layout:fixed;text-align:center">
  <tr>
  	<td style="width:5%;background-size:80%;background-repeat:no-repeat;background-position:left;background-image:url(${map.list[2].avatar});"></td>
    <td style="width:20%">
    	<c:if test="${fn:length(map.list[2].nickName)>5 } ">
			${fn:substring(map.list[2].nickName, 0,5)}...
		</c:if>
		<c:if test="${fn:length(map.list[2].nickName)<=5 }">
			${map.list[2].nickName }
		</c:if>
  	...
  	<td style="width:5%;background-size:80%;background-repeat:no-repeat;background-position:left;background-image:url(data:image/png;base64,);"></td>
    <td style="width:15%">点赞: ${map.list[2].videoLikingCount}</td>
  	<td style="width:7%;background-size:80%;background-repeat:no-repeat;background-position:center;background-image:url(data:image/png;base64,);"></td>
    <td style="width:15%">评论: ${map.list[2].videoCommentCount}</td>
    <td style="width:1%"></td>
  	<td style="width:7%;background-size:80%;background-repeat:no-repeat;background-position:right;background-image:url(data:image/png;base64,);"></td>
    <td style="width:15%">转发: ${map.list[2].videoSendingCount}</td>
    <td style="width:1%"></td>
    </div>
  </tr>
</table>
