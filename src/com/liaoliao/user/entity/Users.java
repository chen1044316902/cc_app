...
public class Users implements Serializable{
	...
	private Integer liao_count;
	
	
	private String wechat;
	
	public Integer getLiao_count() {
		return liao_count;
	}


	public void setLiao_count(Integer liao_count) {
		this.liao_count = liao_count;
	}
	...
	public String toString() {
		return "Users [id=" + id + ", mobile=" + mobile + ", passWord=" + passWord + ", avatar=" + avatar + ", status="
				...
				+ toBankMoney + ".managementMoney="+managementMoney+", loginTime=" + loginTime + ", addTime=" + addTime + ", addIp=" + addIp + ", sex="
